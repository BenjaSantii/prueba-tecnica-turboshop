...
export function PartCard({ part, patch, providerCount = 1 }: PartCardProps) {
  ...
  const imgSrc = getCardImage(part.images, part.category)
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="relative w-full aspect-[4/3] bg-[#F0EEE9] overflow-hidden flex items-center justify-center">
        {imgSrc ? (
          <Image
            src={imgSrc}
            alt={part.name}
          ...
          <div className="flex flex-col items-center gap-1.5 text-[#0F0E0D]/20">
